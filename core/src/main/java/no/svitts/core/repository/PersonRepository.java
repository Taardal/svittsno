...
//
//    @Override
//    public Person getSingleById(String id) {
...
//
//    @Override
//    public Person getSingleByAttributes(Object... attributes) {
...
//            }
//        } catch (SQLException e) {
//            LOGGER.error("Could not updateSingle person {}", person, e);
//            return false;
//        }
//    }
//
...
//            }
//        } catch (SQLException e) {
//            LOGGER.error("Could not deleteSingle person with ID {}", id, e);
//            return false;
//        }
//    }
//
