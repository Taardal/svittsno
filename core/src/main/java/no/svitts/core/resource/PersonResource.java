...
public class PersonResource extends CoreResource {
    ...
    public String getPerson(@PathParam("id") String id) {
        ...
        return gson.toJson(personRepository.getById(id));
    }
    ...
    public Response createPerson(String json) {
        ...
        return getResponse(personRepository.insertSingle(person));
    }
    ...
    public Response updatePerson(@PathParam("id") String id, String json) {
        ...
        Person person = gson.fromJson(json, Person.class);
        return getResponse(personRepository.updateSingle(person));
    }
    ...
    public Response deletePerson(@PathParam("id") String id) {
        ...
        return getResponse(personRepository.deleteSingle(id));
    }
